  ...
  <div class="container my-5 col-8">
    ...
    <div class="report-input">
      <div class="form-group row align-items-center">
        <div class="row mb-3">
          <label for="reportPost" class="col-md-2 col-form-label"><strong>신고 댓글 내용:</strong></label>
          <div class="col-md-10">
            <input type="text" id="postTitle" v-model="replyContent" class="form-control report-text-input" readonly>
          </div>
        </div>
        <div class="row">
        ...
        <label for="reportPost" class="col-md-2 col-form-label" hidden><strong>신고 댓글 Id:</strong></label>
        <div class="col-md-4" hidden>
          <input type="text" id="reportReply" v-model="replyId" class="form-control report-text-input" readonly>
        </div>
      </div>
    </div>
...
export default {
  ...
  data() { //변수생성
    return {
      ...
      categoryName: 'ABUSE',
      replyId: this.$route.query.reportReply,
      description: '',
      idx: '',
      replyContent: this.$route.query.replyContent,
      options: [
        {value: 'ABUSE', text: '욕설'},
  ...
  methods: {
    ...
    fnSave() {
      ...
      this.$axios.post(`/api/v1/reportReply`, this.form, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('user_token')}`
        }
      }).then((res) => {
