<template>
  <div>
    <div class="container mt-5">
      <h3><strong>회원 정보 수정</strong></h3><br><br>
        ...
        <div class="col-md-5">
          <b-card class="mb-5">
            <b-form @submit.prevent="onSubmit" class="form-width mt-3" style="margin: auto;">
              ...
              <div class="mb-4">
                <label for="input-2" class="for정-label text-md-right"><strong>비밀번호</strong></label>
              ...
              <br>
              <b-button @click="onSubmit" class="button-width form-height">수정하기</b-button>
              <br><br>
  ...
  methods: {
    ...
    fnLoginMember() {
      this.$axios.post(`/api/v1/member/myInfo`, {
        ...
        this.form.zoneCode = res.data.data.zoneCode;
        this.form.roadAddress = res.data.data.roadAddress;
    ...
    onSubmit() {
      ...
      this.$axios.post("/api/v1/member/update", this.form, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('user_token')}`
        }
      })
