<template>
  <div>
    <div class="container mt-5">
      <h3><strong>안녕하세요 {{this.form.memberNickname}} 도사님, 수정 할 정보를 입력해주세요 !</strong></h3><br><br>
        ...
        <div class="col-md-5">
          <b-card class="mb-5">
            <b-form @submit.prevent="onSubmit" class="form-width mt-3" style="margin: auto;">
              ...
              <b-button @click="onSubmit" class="button-width form-height">수정 완료</b-button>
...
export default {
  ...
  methods: {
    fnGuruInfo() {
      this.$axios.post('/api/v1/guru/member', "",{
        headers: {
        ...
        this.form.guruInfo = res.data.data.guruInfoId
        ...
        this.form.careerAt = res.data.data.careerAt;
        this.form.contactTime = res.data.data.contactTime;
        this.form.workArea = res.data.data.workArea;
    ...
    onSubmit() {
      ...
      this.$axios.post("/api/v1/guru/update", this.form, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('user_token')}`
        }
      })
